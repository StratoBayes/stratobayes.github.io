...
StratoBayes requires [**R version 4.2.x -- 4.7.x**](https://cran.r-project.org/). We recommend using R through the [RStudio IDE](https://posit.co/downloads/).
...
2.  **Confirm R version in RStudio**:
    ...
    -   If not already selected, chose **R version 4.6.x** (or 4.5.x, 4.4.x, 4.3.x, or 4.2.x) and restart RStudio to apply the change.
...
> **Note**: Currently, StratoBayes binaries are available for R versions 4.2 and upwards (4.2 - 4.6). Ensure your R installation meets this requirement to avoid compatibility issues. Binaries are available for Windows and macOS.
